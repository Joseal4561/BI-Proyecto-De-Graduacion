...
import { CreateInfraestructuraEscolarDto } from './CreateInfraestructura.dto';
import { IsString, IsNotEmpty, IsNumber, IsOptional, IsEnum, IsBoolean } from 'class-validator';

export class UpdateInfraestructuraEscolarDto extends PartialType(CreateInfraestructuraEscolarDto) {
@IsNumber()
  @IsNotEmpty()
  escuelaId: number;
